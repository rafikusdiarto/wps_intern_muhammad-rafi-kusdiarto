...
class StaffKeuanganController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('staff.keuangan.pages.dashboard', [
    ...
    public function index()
    {
        try {
            ...
            return view('staff.keuangan.pages.index', ['getReportStaff' => $reportStaff]);
        } catch(\Throwable $e){
    ...
    {
        try {
            return view('staff.keuangan.pages.create');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('staff-keuangan/report')->with('success', 'data successfully created');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function edit($id)
    {
        try {
            ...
            return view('staff.keuangan.pages.edit', ['getReportStaff' => $reportStaff]);
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('staff-keuangan/report')->with('success', 'data successfully updated');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            $reportStaff->delete();
            return redirect('staff-keuangan/report')->with('success', 'data sucessfully delete');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
