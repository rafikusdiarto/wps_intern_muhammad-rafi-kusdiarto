...
class ManagerOperasionalController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('manager.operasional.pages.dashboard', [
    ...
    public function index()
    {
        try {
            ...
            return view('manager.operasional.pages.index', ['getReportManager' => $reportManager]);
        } catch(\Throwable $e){
    ...
    {
        try {
            return view('manager.operasional.pages.staff-report');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    {
        try {
            return view('manager.operasional.pages.create');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('manager-operasional/report')->with('success', 'data successfully created');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function edit($id)
    {
        try {
            ...
            return view('manager.operasional.pages.edit', ['getReportManager' => $reportManager]);
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('manager-operasional/report')->with('success', 'data successfully updated');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect('manager-operasional/report')->with('success', 'data sucessfully delete');
        } catch(\Throwable $e){
            return redirect()->back()->withError($e->getMessage());
        } catch(\Illuminate\Database\QueryException $e){
            return redirect()->back()->withError($e->getMessage());
