...
<body>
        ...
        <div class="app-menu">
            ...
            <div data-simplebar>
                ...
                <div class="user-box relative text-center mt-5">
                    <img src="{{asset('assets-admin/images/users/user-1.jpg')}}" alt="user-image" class="rounded-full h-14 w-14 p-1 border border-gray-300/30 mx-auto mb-3">
                    <div>
                        ...
                        <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-0 w-40 z-50 transition-all duration-300 bg-white shadow-lg border rounded-lg p-2 border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                            ...
                            @csrf
                                <button type="submit" class="flex items-center py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-primary dark:text-gray-400 hover:text-white dark:hover:text-white">
                ...
                <div class="flex items-center px-6 gap-3">
                    ...
                    <div class="relative">
                        <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link flex items-center">
                            <img src="{{asset('assets-admin/images/users/user-1.jpg')}}" alt="user-image" class="rounded-full h-8 w-8">
    ...
    <!-- App Js -->
    <script src="{{asset('assets-admin/js/app.')}}"></script>
