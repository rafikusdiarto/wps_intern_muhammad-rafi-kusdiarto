...
@if (session('error'))
    ...
    <div class="grid grid-cols-1 pb-6">
        <div class="md:flex items-center justify-between px-[2px]">
            <h4 class="text-[18px] font-medium text-gray-800 mb-sm-0 grow dark:text-gray-100 mb-2 md:mb-0">Manager
            </h4>
                ...
                <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                    ...
                    <li>
                        <div class="flex items-center rtl:mr-2">
                            ...
                            <a href="#"
                                class="text-sm font-medium text-gray-500 ltr:ml-2 rtl:mr-2 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">Edit Report
                                </a>
                        </div>
                    </li>
                </ol>
    ...
    <div class="grid grid-cols-1">
        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
            <div class="card-body border-b border-gray-100 dark:border-zinc-600">
                <h6 class="mb-1 text-gray-700 text-15 dark:text-gray-100">Edit Report</h6>
            </div>
            <div class="card-body">
                <div class="grid grid-cols-12 gap-x-6">
                    <div class="col-span-12 lg:col-span-6">
                        <form action="{{url('manager-operasional/report', $getReportManager->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="manager_id" value="{{ Auth::user()->id }}" id="">
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    type="text" name="report" placeholder="enter your report">{{$getReportManager->report}}</textarea>
                            </div>
                            <div class="mb-4">
                                <label for="example-text-input"
