...
@if (session('error'))
    ...
    <div class="grid grid-cols-1 pb-6">
        <div class="md:flex items-center justify-between px-[2px]">
            <h4 class="text-[18px] font-medium text-gray-800 mb-sm-0 grow dark:text-gray-100 mb-2 md:mb-0">Direktur
            </h4>
            ...
            <div class="card-body">
                <div class="grid grid-cols-12 gap-x-6">
                    <div class="col-span-12 lg:col-span-6">
                        <form action="{{url('direktur/report', $getReportManager->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="manager_id" value="{{$getReportManager->id}}">
                            <div class="mb-4">
