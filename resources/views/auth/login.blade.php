...
<body>
    <div class="h-screen md:flex">
        <div
            ...
            <div>
                <h1 class="text-white font-bold text-4xl font-sans">X Company</h1>
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            ...
            <form class="bg-white" method="POST" action="{{ url('login') }}">
                @csrf
                <h1 class="text-gray-800 font-bold text-2xl mb-1">Please Login!</h1>
