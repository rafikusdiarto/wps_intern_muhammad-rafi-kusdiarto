            ...
            <div class="card-body">
                <div class="grid grid-cols-12 gap-x-6">
                    <div class="col-span-12 lg:col-span-6">
                        <form action="{{url('staff-operasional/report', $getReportStaff->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    type="text" name="report" placeholder="enter your report">{{$getReportStaff->report}}</textarea>
                            </div>
                            <div class="mb-4">
                                <label for="example-text-input"
